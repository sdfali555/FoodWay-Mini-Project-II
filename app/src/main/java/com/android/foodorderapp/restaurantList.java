...
public class restaurantList extends AppCompatActivity implements RestaurantListAdapter.RestaurantListClickListener {
    ...
    public void onItemClick(RestaurantModel restaurantModel) {
        Intent intent = new Intent(restaurantList.this, RestaurantMenuActivity.class);
